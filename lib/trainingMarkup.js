  ...
  <div class="screen active" id="screen-learn_m1">
    ...
    <div class="section">
      ...
      <div class="tilepool_m1" id="tilepool_m1">
        <div class="tile" draggable="true" data-id="t1">Prioritize top accounts, track early-warning signals, and deepen share before attrition</div>
        <div class="tile" draggable="true" data-id="t2">Map wallet by product and competitor to surface gaps and target share systematically</div>
        <div class="tile" draggable="true" data-id="t3">Map decision-makers, align to decision rights, and build multi-level engagement</div>
        <div class="tile" draggable="true" data-id="t4">Invest long-term in knowing clients so you can plan around maturities and strategic events</div>
      </div>

      <div class="zonesrow">
        <div class="zone" data-zone="z1" ondragover="event.preventDefault();this.classList.add('over')" ondragleave="this.classList.remove('over')" ondrop="dropTile_m1(event,'z1')">High value per client</div>
        <div class="zone" data-zone="z2" ondragover="event.preventDefault();this.classList.add('over')" ondragleave="this.classList.remove('over')" ondrop="dropTile_m1(event,'z2')">Wallet is invisible</div>
        <div class="zone" data-zone="z3" ondragover="event.preventDefault();this.classList.add('over')" ondragleave="this.classList.remove('over')" ondrop="dropTile_m1(event,'z3')">Decisions sit high up</div>
        <div class="zone" data-zone="z4" ondragover="event.preventDefault();this.classList.add('over')" ondragleave="this.classList.remove('over')" ondrop="dropTile_m1(event,'z4')">Deals are episodic</div>
      </div>
  ...
  <div class="screen active" id="screen-learn_m2">
    ...
    <div class="section">
      ...
      <div class="tilepool_m2" id="tilepool_m2">
        <div class="tile" draggable="true" data-id="t1">Reviewing last year's wallet share numbers and reading the client's annual report</div>
        <div class="tile" draggable="true" data-id="t2">Deciding which three opportunities to chase this quarter and looping in the trade finance specialist</div>
        <div class="tile" draggable="true" data-id="t3">Sitting down with the client's CFO and walking away with a specific, agreed next step</div>
      </div>

      <div class="zonesrow">
        <div class="zone" data-zone="Think" ondragover="event.preventDefault();this.classList.add('over')" ondragleave="this.classList.remove('over')" ondrop="dropTile_m2(event,'Think')">Think</div>
        <div class="zone" data-zone="Plan" ondragover="event.preventDefault();this.classList.add('over')" ondragleave="this.classList.remove('over')" ondrop="dropTile_m2(event,'Plan')">Plan</div>
        <div class="zone" data-zone="Engage" ondragover="event.preventDefault();this.classList.add('over')" ondragleave="this.classList.remove('over')" ondrop="dropTile_m2(event,'Engage')">Engage</div>
      </div>
...
<div class="tilepool_m3" id="tilepool_m3">
  <div class="tile" draggable="true" data-id="t1">Profile, ownership, governance, business model, value chain</div>
  <div class="tile" draggable="true" data-id="t2">Trend analysis, wallet share, product penetration</div>
  <div class="tile" draggable="true" data-id="t3">Relationship heat map and a development plan</div>
  <div class="tile" draggable="true" data-id="t4">The long list of opportunities across Risk, Deposit, FX, and Fee Income</div>
</div>
<div class="zonesrow cols4">
  <div class="zone" data-zone="z1" ondragover="event.preventDefault();this.classList.add('over')" ondragleave="this.classList.remove('over')" ondrop="dropTile_m3(event,'z1')">Company overview</div>
  <div class="zone" data-zone="z2" ondragover="event.preventDefault();this.classList.add('over')" ondragleave="this.classList.remove('over')" ondrop="dropTile_m3(event,'z2')">Financial performance</div>
  <div class="zone" data-zone="z3" ondragover="event.preventDefault();this.classList.add('over')" ondragleave="this.classList.remove('over')" ondrop="dropTile_m3(event,'z3')">Relationship mapping</div>
  <div class="zone" data-zone="z4" ondragover="event.preventDefault();this.classList.add('over')" ondragleave="this.classList.remove('over')" ondrop="dropTile_m3(event,'z4')">Opportunity pipeline</div>
</div>
...
<div class="tilepool_m4" id="tilepool_m4">
  <div class="tile" draggable="true" data-id="t1">20%</div>
  <div class="tile" draggable="true" data-id="t2">2%</div>
  <div class="tile" draggable="true" data-id="t3">6%</div>
</div>
<div class="zonesrow cols3">
  <div class="zone" data-zone="z1" ondragover="event.preventDefault();this.classList.add('over')" ondragleave="this.classList.remove('over')" ondrop="dropTile_m4(event,'z1')">Your answer</div>
</div>
...
<div class="tilepool_m5" id="tilepool_m5">
  <div class="tile" draggable="true" data-id="t1">Decision Maker</div>
  <div class="tile" draggable="true" data-id="t2">Gatekeeper</div>
  <div class="tile" draggable="true" data-id="t3">Positive</div>
  <div class="tile" draggable="true" data-id="t4">Neutral</div>
</div>
<div class="zonesrow">
  <div class="zone" data-zone="z1" ondragover="event.preventDefault();this.classList.add('over')" ondragleave="this.classList.remove('over')" ondrop="dropTile_m5(event,'z1')">Influence level</div>
  <div class="zone" data-zone="z2" ondragover="event.preventDefault();this.classList.add('over')" ondragleave="this.classList.remove('over')" ondrop="dropTile_m5(event,'z2')">Sentiment</div>
</div>
...
<div class="tilepool_m6" id="tilepool_m6">
  <div class="tile" draggable="true" data-id="t1">GHS 450,000</div>
  <div class="tile" draggable="true" data-id="t2">GHS 900,000</div>
  <div class="tile" draggable="true" data-id="t3">GHS 45,000</div>
</div>
<div class="zonesrow cols3">
  <div class="zone" data-zone="z1" ondragover="event.preventDefault();this.classList.add('over')" ondragleave="this.classList.remove('over')" ondrop="dropTile_m6(event,'z1')">Your answer</div>
</div>
  ...
  <div class="screen active" id="screen-s1_m7">
    ...
    <div class="section">
      ...
      <div class="tilepool" id="tilepool1_m7">
        <div class="tile" draggable="true" data-id="a1">Private / local</div>
        <div class="tile" draggable="true" data-id="a2">Public / listed</div>
        <div class="tile" draggable="true" data-id="a3">Public sector / SOE</div>
        <div class="tile" draggable="true" data-id="a4">Global / group</div>
      </div>
  ...
  <div class="screen" id="screen-s2_m7">
    ...
    <div class="section">
      ...
      <div class="tilepool" id="tilepool2_m7">
        <div class="tile" draggable="true" data-id="t1">Source pack</div>
        <div class="tile" draggable="true" data-id="t2">Client archetype</div>
        <div class="tile" draggable="true" data-id="t3">Output format</div>
        <div class="tile" draggable="true" data-id="t4">Proof and gaps</div>
        <div class="tile" draggable="true" data-id="t5">Escalate to action</div>
      </div>
      <div class="zonesrow" style="grid-template-columns:repeat(5,1fr);">
        <div class="zone" data-zone="S" ondragover="event.preventDefault();this.classList.add('over')" ondragleave="this.classList.remove('over')" ondrop="dropTile2_m7(event,'S')">S</div>
        <div class="zone" data-zone="C" ondragover="event.preventDefault();this.classList.add('over')" ondragleave="this.classList.remove('over')" ondrop="dropTile2_m7(event,'C')">C</div>
        <div class="zone" data-zone="O" ondragover="event.preventDefault();this.classList.add('over')" ondragleave="this.classList.remove('over')" ondrop="dropTile2_m7(event,'O')">O</div>
        <div class="zone" data-zone="P" ondragover="event.preventDefault();this.classList.add('over')" ondragleave="this.classList.remove('over')" ondrop="dropTile2_m7(event,'P')">P</div>
        <div class="zone" data-zone="E" ondragover="event.preventDefault();this.classList.add('over')" ondragleave="this.classList.remove('over')" ondrop="dropTile2_m7(event,'E')">E</div>
      </div>
...
<div class="tilepool_m8" id="tilepool_m8">
  <div class="tile" draggable="true" data-id="t1">A named owner</div>
  <div class="tile" draggable="true" data-id="t2">A target date</div>
  <div class="tile" draggable="true" data-id="t3">A validation question</div>
  <div class="tile" draggable="true" data-id="t4">A next action (present, though vague)</div>
</div>
<div class="zonesrow">
  <div class="zone" data-zone="missing" ondragover="event.preventDefault();this.classList.add('over')" ondragleave="this.classList.remove('over')" ondrop="dropTile_m8(event,'missing')">Missing</div>
  <div class="zone" data-zone="present" ondragover="event.preventDefault();this.classList.add('over')" ondragleave="this.classList.remove('over')" ondrop="dropTile_m8(event,'present')">Already present</div>
</div>
