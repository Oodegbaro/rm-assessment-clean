...
function assignTileToZone_m1(id, zone){
...
function dropTile_m1(e, zone){
  ...
  if(!tile) return;
  assignTileToZone_m1(id, zone);
}
function tileClicked_m1(tileEl){
  if(tileEl.classList.contains('placed')) return;
  const id = tileEl.dataset.id;
  document.querySelectorAll('.tile').forEach(t => t.classList.remove('armed'));
  if(armedTileId === id){ armedTileId = null; return; }
  armedTileId = id;
  tileEl.classList.add('armed');
}
function zoneClicked_m1(zoneEl){
  if(!armedTileId) return;
  assignTileToZone_m1(armedTileId, zoneEl.dataset.zone);
  document.querySelectorAll('.tile').forEach(t => t.classList.remove('armed'));
  armedTileId = null;
}
...
renderZones_m1();
  ...
  window.tileClicked_m1 = tileClicked_m1;
  window.zoneClicked_m1 = zoneClicked_m1;
})();
...
let armedTileId = null;
function assignTileToZone_m2(id, zone){
  Object.keys(placements).forEach(z => { if(placements[z]===id) delete placements[z]; });
  placements[zone] = id;
  renderZones_m2();
}
function dropTile_m2(e, zone){
  ...
  if(!tile) return;
  assignTileToZone_m2(id, zone);
}
function tileClicked_m2(tileEl){
  if(tileEl.classList.contains('placed')) return;
  const id = tileEl.dataset.id;
  document.querySelectorAll('.tile').forEach(t => t.classList.remove('armed'));
  if(armedTileId === id){ armedTileId = null; return; }
...
function zoneClicked_m2(zoneEl){
  if(!armedTileId) return;
  assignTileToZone_m2(armedTileId, zoneEl.dataset.zone);
  document.querySelectorAll('.tile').forEach(t => t.classList.remove('armed'));
  armedTileId = null;
}
...
function goTo_m2(screen){
  ...
  window.tileClicked_m2 = tileClicked_m2;
  window.zoneClicked_m2 = zoneClicked_m2;
})();
...
let armedTileId = null;
function assignTileToZone_m3(id, zone){
  Object.keys(placements).forEach(z => { if(placements[z]===id) delete placements[z]; });
  placements[zone] = id;
  renderZones_m3();
}
function dropTile_m3(e, zone){
  ...
  if(!tile) return;
  assignTileToZone_m3(id, zone);
}
function tileClicked_m3(tileEl){
  if(tileEl.classList.contains('placed')) return;
  const id = tileEl.dataset.id;
  document.querySelectorAll('.tile').forEach(t => t.classList.remove('armed'));
  if(armedTileId === id){ armedTileId = null; return; }
...
function zoneClicked_m3(zoneEl){
  if(!armedTileId) return;
  assignTileToZone_m3(armedTileId, zoneEl.dataset.zone);
  document.querySelectorAll('.tile').forEach(t => t.classList.remove('armed'));
  armedTileId = null;
}
...
renderZones_m3();
  ...
  window.tileClicked_m3 = tileClicked_m3;
  window.zoneClicked_m3 = zoneClicked_m3;
})();
...
let armedTileId = null;
function assignTileToZone_m4(id, zone){
  Object.keys(placements).forEach(z => { if(placements[z]===id) delete placements[z]; });
  placements[zone] = id;
  renderZones_m4();
}
function dropTile_m4(e, zone){
  ...
  if(!tile) return;
  assignTileToZone_m4(id, zone);
}
function tileClicked_m4(tileEl){
  if(tileEl.classList.contains('placed')) return;
  const id = tileEl.dataset.id;
  document.querySelectorAll('.tile').forEach(t => t.classList.remove('armed'));
  if(armedTileId === id){ armedTileId = null; return; }
...
function zoneClicked_m4(zoneEl){
  if(!armedTileId) return;
  assignTileToZone_m4(armedTileId, zoneEl.dataset.zone);
  document.querySelectorAll('.tile').forEach(t => t.classList.remove('armed'));
  armedTileId = null;
}
...
renderZones_m4();
  ...
  window.tileClicked_m4 = tileClicked_m4;
  window.zoneClicked_m4 = zoneClicked_m4;
})();
...
let armedTileId = null;
function assignTileToZone_m5(id, zone){
  Object.keys(placements).forEach(z => { if(placements[z]===id) delete placements[z]; });
  placements[zone] = id;
  renderZones_m5();
}
function dropTile_m5(e, zone){
  ...
  if(!tile) return;
  assignTileToZone_m5(id, zone);
}
function tileClicked_m5(tileEl){
  if(tileEl.classList.contains('placed')) return;
  const id = tileEl.dataset.id;
  document.querySelectorAll('.tile').forEach(t => t.classList.remove('armed'));
  if(armedTileId === id){ armedTileId = null; return; }
...
function zoneClicked_m5(zoneEl){
  if(!armedTileId) return;
  assignTileToZone_m5(armedTileId, zoneEl.dataset.zone);
  document.querySelectorAll('.tile').forEach(t => t.classList.remove('armed'));
  armedTileId = null;
}
...
renderZones_m5();
  ...
  window.tileClicked_m5 = tileClicked_m5;
  window.zoneClicked_m5 = zoneClicked_m5;
})();
...
let armedTileId = null;
function assignTileToZone_m6(id, zone){
  Object.keys(placements).forEach(z => { if(placements[z]===id) delete placements[z]; });
  placements[zone] = id;
  renderZones_m6();
}
function dropTile_m6(e, zone){
  ...
  if(!tile) return;
  assignTileToZone_m6(id, zone);
}
function tileClicked_m6(tileEl){
  if(tileEl.classList.contains('placed')) return;
  const id = tileEl.dataset.id;
  document.querySelectorAll('.tile').forEach(t => t.classList.remove('armed'));
  if(armedTileId === id){ armedTileId = null; return; }
...
function zoneClicked_m6(zoneEl){
  if(!armedTileId) return;
  assignTileToZone_m6(armedTileId, zoneEl.dataset.zone);
  document.querySelectorAll('.tile').forEach(t => t.classList.remove('armed'));
  armedTileId = null;
}
...
renderZones_m6();
  ...
  window.tileClicked_m6 = tileClicked_m6;
  window.zoneClicked_m6 = zoneClicked_m6;
})();
...
function assignTile1_m7(id){
  place1 = id;
  const tile = document.querySelector('#tilepool1_m7 [data-id="'+id+'"]');
  const zoneEl = document.querySelector('#screen-s1_m7 .zone');
  zoneEl.innerHTML = 'Your answer<div class="placedtile">'+tile.textContent+'</div>';
...
function dropTile1_m7(e){
  ...
  assignTile1_m7(e.dataTransfer.getData('text'));
}
function tileClicked1_m7(tileEl){
  if(tileEl.classList.contains('placed')) return;
  assignTile1_m7(tileEl.dataset.id);
}
...
let armedTileId2 = null;
function assignTileToZone2_m7(id, zone){
...
function dropTile2_m7(e, zone){
  e.preventDefault(); e.currentTarget.classList.remove('over');
  const id = e.dataTransfer.getData('text');
  assignTileToZone2_m7(id, zone);
}
function tileClicked2_m7(tileEl){
  if(tileEl.classList.contains('placed')) return;
  const id = tileEl.dataset.id;
  document.querySelectorAll('#tilepool2_m7 .tile').forEach(t => t.classList.remove('armed'));
  if(armedTileId2 === id){ armedTileId2 = null; return; }
  armedTileId2 = id;
  tileEl.classList.add('armed');
}
function zoneClicked2_m7(zoneEl){
  if(!armedTileId2) return;
  assignTileToZone2_m7(armedTileId2, zoneEl.dataset.zone);
  document.querySelectorAll('#tilepool2_m7 .tile').forEach(t => t.classList.remove('armed'));
  armedTileId2 = null;
}
...
function renderEvaluation_m7(ev, demo){
  ...
  window.tileClicked1_m7 = tileClicked1_m7;
  window.tileClicked2_m7 = tileClicked2_m7;
  window.zoneClicked2_m7 = zoneClicked2_m7;
})();
...
let armedTileId = null;
function assignTileToZone_m8(id, zone){
  Object.keys(placements).forEach(k => {
    if(placements[k]) placements[k] = placements[k].filter(x => x !== id);
  });
...
function dropTile_m8(e, zone){
  ...
  e.currentTarget.classList.remove("over");
  const id = e.dataTransfer.getData("text");
  assignTileToZone_m8(id, zone);
}
function tileClicked_m8(tileEl){
  if(tileEl.classList.contains('placed')) return;
  const id = tileEl.dataset.id;
  document.querySelectorAll('.tile').forEach(t => t.classList.remove('armed'));
  if(armedTileId === id){ armedTileId = null; return; }
...
function zoneClicked_m8(zoneEl){
  if(!armedTileId) return;
  assignTileToZone_m8(armedTileId, zoneEl.dataset.zone);
  document.querySelectorAll('.tile').forEach(t => t.classList.remove('armed'));
  armedTileId = null;
}
...
renderZones_m8();
  ...
  window.tileClicked_m8 = tileClicked_m8;
  window.zoneClicked_m8 = zoneClicked_m8;
})();
